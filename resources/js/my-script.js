...
function konfirmasi(event) {
    ...
    switch (tombol.getAttribute('data-table')) {
        case 'kelas':
            judulAlert = 'Hapus Kelas' + tombol.getAttribute('data-name') + '?';
            teksAlert = 'Semua data <b>Siswa</b> dan ' +
                'untuk Kelas ini juga akan ' +
                'terhapus!';
            break;
        case 'siswa':
            judulAlert = 'Hapus Siswa ' + tombol.getAttribute('data-name') + '?';
